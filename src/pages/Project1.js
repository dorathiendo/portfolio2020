...
import Image1 from './../images/project1_1.jpg';
import Image2 from './../images/project1_2.jpg';
import Image3 from '../images/project1_3.jpg';

export default function Project1({ className = "" }) {
    return (
        <div className={`content project1 ${className}`}>
